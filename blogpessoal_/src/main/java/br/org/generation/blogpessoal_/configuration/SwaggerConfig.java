package br.org.generation.blogpessoal_.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.generation.blogpessoal_.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/liviaoliveiraa")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Lívia Oliveira", 
			"https://github.com/liviaoliveiraa", 
			"livia.oliveira.almeida@hotmail.com");
